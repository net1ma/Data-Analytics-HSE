...
В представленном репозитории хранится список проектов, выполненных в рамках курса «‎Аналитика данных». Проект написаны на языках Python и SQL. Решение подготовлены в Jupyter Notebook.
